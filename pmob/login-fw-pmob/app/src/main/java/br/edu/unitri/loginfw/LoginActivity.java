...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton = findViewById(R.id.bEntrarFace);
        ...
        final TextView tvCriar = findViewById(R.id.tvCriar);

        tvCriar.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                chamaCadastro(v);
            }
        });
